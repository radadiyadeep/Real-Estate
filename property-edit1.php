...
if(isset($_POST['update']))
{
	...
	$sql = "UPDATE tbl_seller SET title= '{$title}', category_id='{$ptype}', bhk='{$bhk}', stype='{$stype}',
	badroom='{$bed}', bathroom='{$bath}', balcony='{$balc}', kitchen='{$kitc}', hall='{$hall}',
	size='{$asize}', price='{$price}', location='{$loc}', location_id='{$location_id}', state='{$state}', feature='{$feature}',
	pimage='{$aimage}', pimage1='{$aimage1}', pimage2='{$aimage2}', pimage3='{$aimage3}', pimage4='{$aimage4}',user_id='{$uid}', status='{$status}' WHERE property_id ='{$pid}'";
        ...
        ?>
            ...
            <div class="page-wrapper">
                ...
                <?php
									...
									$pid=$_REQUEST['eid'];
									$query=mysqli_query($connection,"select * from tbl_seller where property_id='$pid'");
										...
										<div class="row">
											...
											<div class="col-xl-6">
												<div class="form-group row">
													...
													<div class="col-lg-9">
														<select class="form-control"  name="ptype" required value="<?php echo $row_list['3']; ?>">
